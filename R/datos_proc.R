...
datare <-
  ...
  mutate(region = case_when
         (region %in% c(Arica y Parinacota, Trapacá, Antofagasta, Atacama) ~ "Macrozona Norte",
          region %in% c(Coquimbo, Valparaíso) ~ "Macrozona Centro",
          region %in% c(Libertador General Bernardo Ohiggins, Maule, Ñuble, Biobío) ~ "Macrozona Centro Sur",
